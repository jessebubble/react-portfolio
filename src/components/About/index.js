...
const testimonials = [
  {
    ...
    avatar:
    'https://images.unsplash.com/photo-1566703410327-a4871d44b47e?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2071&q=80',
  },
  {
    name: 'Jesse HernandezIII',
    role: 'Web Developer',
    content:
      "Holds a Full Stack Web Development certificate from the University of Texas, San Antonio.",
    avatar:
    "https://images.unsplash.com/photo-1629898569904-669319348211?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1074&q=80",
  },
  {
    name: 'Jesse H',
    role: 'iOS Developer',
    content:
      "Current focus is on mobile-first design and development. Continues independent studies to learn more about iOS development with SwiftUI ",
    avatar:
